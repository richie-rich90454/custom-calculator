...
export class DefaultResultFormattingService implements ResultFormattingService {
    ...
    public formatNumber(value: number): string {
        ...
        if (
            absoluteValue >= DefaultResultFormattingService.SCIENTIFIC_NOTATION_UPPER_BOUND ||
            absoluteValue < DefaultResultFormattingService.SCIENTIFIC_NOTATION_LOWER_BOUND
        ) {
