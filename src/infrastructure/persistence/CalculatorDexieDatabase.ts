...
export class CalculatorDexieDatabase extends Dexie {
    ...
    public fromHistoryEntryRecord(record: HistoryEntryRecord): HistoryEntry {
    ...
    public toVariableAssignmentRecord(variable: VariableAssignment): VariableAssignmentRecord {
        return {
            name: variable.name,
    ...
    public fromVariableAssignmentRecord(record: VariableAssignmentRecord): VariableAssignment {
