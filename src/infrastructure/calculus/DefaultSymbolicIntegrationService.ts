...
export class DefaultSymbolicIntegrationService
  implements SymbolicIntegrationService
{
  ...
  private integrateQuotientNode(
    ...
    if (!this.containsSymbol(numerator, variableName)) {
      ...
      const denominatorPower = this.asPowerOfVariable(
        denominator,
        variableName
      );
  ...
  private integratePowerNode(
    ...
    if (
      this.isSymbol(base, variableName) &&
  ...
  private integrateFunctionNode(
    ...
    switch (functionName) {
      case "sin":
        return this.buildUnaryMinus(
          this.buildFunction("cos", variableArgument)
        );
      case "cos":
      ...
      case "ln":
        return this.buildSubtract(
          this.buildMultiply(variableArgument, this.buildFunction("log", variableArgument)),
          variableArgument
        );
      case "sqrt":
  ...
  private buildOperator(
    ...
    return new math.OperatorNode(op as never, fn as never, args as never) as unknown as MathJsNode;
  }
