...
function createFraction(factory: DefaultMathJsFractionValueFactory, valueText: string): string {
...
describe("DefaultMathJsFractionValueFactory", () => {
    ...
    it("expands a negative exponent notation value", () => {
        expect(buildFactory().expandExponentNotation("6.6743e-11")).toBe("0.000000000066743");
    });
    ...
    it("expands an exponent on an integer mantissa", () => {
        expect(buildFactory().expandExponentNotation("299792458e0")).toBe("299792458");
    });
    ...
    it("creates an exact fraction from exponent notation text", () => {
        ...
        expect(createFraction(factory, "6.6743e-11")).toBe("0.000000000066743");
    });
