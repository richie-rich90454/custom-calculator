...
describe("MathJsCalculationErrorMapper", () => {
    ...
    describe("mapParseError", () => {
        it("maps an unexpected end of expression to missing parentheses", () => {
            const error = mapper.mapParseError(new Error("Unexpected end of expression"));
    ...
    describe("mapEvaluationError", () => {
        it("maps lowercase division by zero", () => {
            const error = mapper.mapEvaluationError(new Error("Division by zero"));
        ...
        it("maps an undefined function message", () => {
            const error = mapper.mapEvaluationError(new Error("Undefined function mystery"));
        ...
        it("maps an undefined symbol message", () => {
            const error = mapper.mapEvaluationError(new Error("Undefined symbol zz"));
        ...
        it("maps an unexpected token message", () => {
            const error = mapper.mapEvaluationError(new Error("Unexpected token ]"));

            expect(error.code).toBe(CalculationErrorCode.SYNTAX_ERROR);
        });

        it("maps any other evaluation message to a generic failure", () => {
            const error = mapper.mapEvaluationError(new Error("Value must be positive"));
