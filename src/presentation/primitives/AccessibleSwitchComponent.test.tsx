...
describe("AccessibleSwitchComponent", () => {
    it("uses the label as the accessible text when children are omitted", () => {
        ...
        expect(screen.getByRole("switch", { name: "Complex numbers" })).toBeInTheDocument();
    });
    ...
    it("uses the children as the accessible text when provided", () => {
        ...
        expect(screen.getByRole("switch", { name: "Enable complex numbers" })).toBeInTheDocument();
    });
    ...
    it("fires the change handler when activated", async () => {
        ...
        render(
            <AccessibleSwitchComponent label="CAS mode" isSelected={false} onChange={onChange}>
                CAS mode
            </AccessibleSwitchComponent>,
        );
