...
export class ConstantsPanelViewModel {
    ...
    private static readonly CATEGORY_LABELS: Readonly<Record<ScientificConstantCategory, string>> =
        {
    ...
    private matchesSearchText(constant: ScientificConstant, normalizedSearchText: string): boolean {
        const candidates = [
            constant.name,
            constant.symbol,
            constant.id,
