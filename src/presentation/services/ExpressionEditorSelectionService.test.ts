...
import { ExpressionEditorSelectionService } from "./ExpressionEditorSelectionService";

describe("ExpressionEditorSelectionService", () => {
  const service = new ExpressionEditorSelectionService();
