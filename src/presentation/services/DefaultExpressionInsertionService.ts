 ...
 */
export class DefaultExpressionInsertionService
  implements ExpressionInsertionService
{
  public constructor(
    private readonly cursorService: ExpressionCursorService
  ) {}
  ...
  public insertTemplate(
    ...
    const nextText = hasSelection && template.wrapsSelection
      ? this.wrapSelection(
          currentText,
          template,
