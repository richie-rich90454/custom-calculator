 ...
 */
export class DefaultButtonInsertionTemplateService
  implements ButtonInsertionTemplateService
{
  private static readonly TEMPLATE_BY_FUNCTION_NAME: Readonly<
  ...
  public resolveFunctionTemplate(functionName: string): CalculatorButtonTemplate {
    const templateText =
      DefaultButtonInsertionTemplateService.TEMPLATE_BY_FUNCTION_NAME[
        functionName
      ];
