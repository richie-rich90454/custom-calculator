 ...
 */
export class DefaultKeypadDefinitionRepository implements KeypadDefinitionRepository {
    private static readonly SCIENTIFIC_FUNCTION_KEYS: readonly CalculatorKeyDefinition[] = [
        ...
        },
        {
            id: "asin",
            label: "asin",
            ariaLabel: "Inverse sine function",
            kind: CalculatorKeyKind.FUNCTION,
            value: "asin",
        },
        {
            id: "acos",
            label: "acos",
            ariaLabel: "Inverse cosine function",
            kind: CalculatorKeyKind.FUNCTION,
            value: "acos",
        },
        {
            id: "atan",
            label: "atan",
            ariaLabel: "Inverse tangent function",
            kind: CalculatorKeyKind.FUNCTION,
            value: "atan",
        },
        {
            id: "sinh",
            label: "sinh",
            ariaLabel: "Hyperbolic sine function",
            kind: CalculatorKeyKind.FUNCTION,
            value: "sinh",
        },
        {
            id: "cosh",
            label: "cosh",
            ariaLabel: "Hyperbolic cosine function",
            kind: CalculatorKeyKind.FUNCTION,
            value: "cosh",
        },
        {
            id: "tanh",
            label: "tanh",
            ariaLabel: "Hyperbolic tangent function",
            kind: CalculatorKeyKind.FUNCTION,
            value: "tanh",
        },
        {
            id: "asinh",
            label: "asinh",
            ariaLabel: "Inverse hyperbolic sine function",
            kind: CalculatorKeyKind.FUNCTION,
            value: "asinh",
        },
        {
            id: "acosh",
            label: "acosh",
            ariaLabel: "Inverse hyperbolic cosine function",
            kind: CalculatorKeyKind.FUNCTION,
            value: "acosh",
        },
        {
            id: "atanh",
            label: "atanh",
            ariaLabel: "Inverse hyperbolic tangent function",
            kind: CalculatorKeyKind.FUNCTION,
            value: "atanh",
        },
        {
        ...
        },
        {
            id: "exp",
            label: "exp",
            ariaLabel: "Exponential function",
            kind: CalculatorKeyKind.FUNCTION,
            value: "exp",
        },
        {
        ...
        },
        {
            id: "gcd",
            label: "gcd",
            ariaLabel: "Greatest common divisor",
            kind: CalculatorKeyKind.FUNCTION,
            value: "gcd",
        },
        {
            id: "lcm",
            label: "lcm",
            ariaLabel: "Least common multiple",
            kind: CalculatorKeyKind.FUNCTION,
            value: "lcm",
        },
        {
    ...
    private static readonly CORE_KEYS: readonly CalculatorKeyDefinition[] = [
        ...
        },
        {
            ...
            label: "⌫",
            ariaLabel: "Backspace",
            kind: CalculatorKeyKind.DELETE_BACKWARD,
            value: "",
        },
        {
            id: "paren-open",
            ...
            kind: CalculatorKeyKind.PARENTHESIS,
            value: "(",
        },
        {
            id: "paren-close",
        ...
        },
        {
            ...
            label: "%",
            ariaLabel: "Percent",
            kind: CalculatorKeyKind.OPERATOR,
            value: "%",
        },
        {
            id: "factorial",
        ...
        },
        {
            ...
            kind: CalculatorKeyKind.CONSTANT,
            value: "pi",
        },
        ...
        },
        {
            ...
            kind: CalculatorKeyKind.MEMORY_RECALL,
            value: "",
        },
        {
            id: "equals",
            label: "=",
            ariaLabel: "Evaluate",
            kind: CalculatorKeyKind.EVALUATE,
            value: "",
        },
    ];
