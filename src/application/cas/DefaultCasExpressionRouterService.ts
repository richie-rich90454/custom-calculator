 ...
 */
export class DefaultCasExpressionRouterService implements CasExpressionRouterService {
    ...
    private executeOperation(blockDescriptor: CasBlockDescriptor, casService: CasService): string {
        switch (blockDescriptor.operationKind) {
            case CasOperationKind.SIMPLIFY:
                return casService.simplifyExpression(blockDescriptor.innerExpressionText);
