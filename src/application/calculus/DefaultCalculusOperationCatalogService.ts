...
export class DefaultCalculusOperationCatalogService implements CalculusOperationCatalogService {
    private static readonly OPERATIONS: readonly CalculusOperationDefinition[] = [
        ...
        },
        {
            ...
            invocationText: "sum(",
            description: "Sums the wrapped expression over an integer range.",
        },
        {
            ...
            description: "Multiplies the wrapped expression over an integer range.",
        },
    ];
