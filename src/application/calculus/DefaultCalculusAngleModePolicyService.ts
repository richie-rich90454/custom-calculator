...
export class DefaultCalculusAngleModePolicyService implements CalculusAngleModePolicyService {
    ...
    public resolveSymbolicAngleWarning(
        ...
        if (policy === CalculusAngleModePolicy.RADIANS_ONLY && angleMode !== AngleMode.RAD) {
