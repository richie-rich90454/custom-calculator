...
export interface CalculatorApplicationController {
    ...
    insertDigit(currentState: CalculatorSessionState, digit: string): CalculatorSessionState;

    insertOperator(currentState: CalculatorSessionState, operator: string): CalculatorSessionState;
    ...
    deleteWordBackward(currentState: CalculatorSessionState): CalculatorSessionState;
    ...
    evaluateExpression(currentState: CalculatorSessionState): CalculatorSessionState;
    ...
    toggleComplexNumbers(currentState: CalculatorSessionState): CalculatorSessionState;
    ...
    simplifyExpression(currentState: CalculatorSessionState): CalculatorSessionState;

    expandExpression(currentState: CalculatorSessionState): CalculatorSessionState;
