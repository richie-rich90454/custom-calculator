      ...
      nav: [
        {
          ...
          items: [
            ...
            { text: "Scientific Reference", link: "/scientific-reference/function-catalog" },
        ...
        "/getting-started/": [
          {
            ...
            items: [
              ...
              { text: "First Calculation", link: "/getting-started/first-calculation" },
              { text: "Interface Tour", link: "/getting-started/interface-tour" },
              { text: "Keyboard First Usage", link: "/getting-started/keyboard-first-usage" },
            ],
          },
        ],
        ...
        "/user-guide/": [
          {
            ...
            items: [
              ...
              { text: "Implicit Multiplication", link: "/user-guide/implicit-multiplication" },
              { text: "Operator Precedence", link: "/user-guide/operator-precedence" },
        ...
        "/scientific-reference/": [
          {
            ...
            items: [
              { text: "Function Catalog", link: "/scientific-reference/function-catalog" },
              { text: "Math Constants", link: "/scientific-reference/constants-math" },
              { text: "Physics Constants", link: "/scientific-reference/constants-physics" },
              { text: "Chemistry Constants", link: "/scientific-reference/constants-chemistry" },
              { text: "Atomic Constants", link: "/scientific-reference/constants-atomic" },
              { text: "Notation Guide", link: "/scientific-reference/notation-guide" },
            ],
          },
        ],
        ...
        "/calculus/": [
          {
            ...
            items: [
              ...
              { text: "Symbolic Integration", link: "/calculus/symbolic-integration" },
        ...
        "/developer/": [
          {
            ...
            items: [
              { text: "Repository Structure", link: "/developer/repository-structure" },
              ...
              { text: "Infrastructure Layer", link: "/developer/infrastructure-layer" },
              ...
              { text: "Adding a CAS Operation", link: "/developer/adding-a-cas-operation" },
              { text: "Adding a Numeric Mode", link: "/developer/adding-a-numeric-mode" },
        ...
        "/architecture/": [
          {
            ...
            items: [
              ...
              { text: "Evaluation Pipeline", link: "/architecture/evaluation-pipeline" },
              ...
              { text: "Expression Editing Model", link: "/architecture/expression-editing-model" },
        ...
        "/api/": [
          {
            text: "API Reference",
            items: [
              { text: "API Reference Index", link: "/api/api-reference-index" },
            ],
          },
        ],
      },
