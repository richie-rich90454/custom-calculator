                ...
                "/user-guide/": [
                    {
                        ...
                        items: [
                            ...
                            { text: "Base-N", link: "/user-guide/base-n" },
                            { text: "Matrix", link: "/user-guide/matrix" },
                            { text: "Vector", link: "/user-guide/vector" },
                            { text: "BigInt Mode", link: "/user-guide/bigint-mode" },
                            { text: "Statistics", link: "/user-guide/statistics" },
                            { text: "Table", link: "/user-guide/table" },
                            { text: "Equation", link: "/user-guide/equation" },
                            { text: "Ratio", link: "/user-guide/ratio" },
