...
The calculator follows the standard math.js operator precedence, which matches the conventional order taught in mathematics.
...
Multiplication binds tighter than addition, so this evaluates to `14`, not `20`.
...
- [Implicit multiplication](/user-guide/implicit-multiplication) explains adjacency multiplication.
