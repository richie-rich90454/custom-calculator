...
The calculator can evaluate expressions that involve complex numbers. Complex support is opt-in and toggled in the settings panel.

## Enabling complex numbers

Open the settings panel and toggle **Complex numbers**. When enabled, the status bar indicates the complex mode.
...
- When complex support is enabled, operations that would otherwise produce an error can produce complex results.
