---
title: Settings
description: A reference for every setting available in the settings panel.
---
...
- [Angle modes](/user-guide/angle-modes) explains angle behavior.
- [Numeric modes](/user-guide/numeric-modes) explains numeric behavior.
