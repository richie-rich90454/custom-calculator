---
title: Roadmap
description: The planned direction of the scientific calculator.
---
...
- **Additional numeric modes** — more exact arithmetic strategies.
- **Expanded function catalog** — additional special functions.
- **More calculus operations** — additional numeric and symbolic techniques.

## Long term

- **More symbolic capabilities** — deeper CAS coverage.
- **Custom keypad layouts** — user-configurable keypad arrangement.
- **Import and export** — expression and history export.
