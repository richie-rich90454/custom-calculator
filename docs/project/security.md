...
Security is important to this project. If you believe you have found a
security issue, please report it responsibly.

## Security posture

- Expressions are parsed through the math.js parser, never through `eval` or
  `new Function`.
...
privately through the project maintainers. Include:
...
Reported issues are acknowledged and triaged. A fix and disclosure are
coordinated before public announcement where appropriate.
